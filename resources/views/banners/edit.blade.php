                    ...
                    <form method="POST" action="{{ route('banners.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="redirect" value="{{ old('redirect') ?? $banner->redirect }}">
                            </div>
                            <div class="col-md-3">
                                <label>Estado</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                @php
                                    ...
                                    $imageLg = $banner->images->first(function ($image) {
                                        return $image->screen === 'lg';
                                    });
                                ...
                                @if ($imageLg)
                                    ...
                                    <img src='{{ asset($imageLg->path) }}' alt="" width="100%">
                                @else
                            ...
                            <div class="col-md-6">
                                ...
                                @php
                                    ...
                                    $imageSm = $banner->images->first(function ($image) {
                                        return $image->screen === 'sm';
                                    });
                                ...
                                @if ($imageSm)
                                    <h3>Imagen Mobile</h3>
                                    <img src='{{ asset($imageSm->path) }}' alt="" width="100%">
                                @else
